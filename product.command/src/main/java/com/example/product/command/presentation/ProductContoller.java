package com.example.product.command.presentation;
...
import com.example.product.command.presentation.requests.ApplyDiscountRequest;
...
import com.example.product.command.presentation.response.BaseResponse;
